...
<head>
    ...
    <title>About Us | TechLearn ICT Academy</title>
    ...
    <style>
        ...
        * {
        ...
        /* Header Navigation - Copied & Modified */
        .navbar {
            position: fixed;
            top: 0;
            width: 100%;
        ...
        .btn-outline { background: var(--light); border: 1px solid var(--border); color: var(--dark); }
